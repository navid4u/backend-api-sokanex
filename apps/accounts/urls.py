...
from .views import (
    ...
    OTPRequestView,
    OTPVerifyView,
    RegistrationOTPRequestView,
    RegistrationOTPVerifyView,
    FinancialPersonalityCurrentView,
    FinancialPersonalitySubmitView,
...
urlpatterns = [
    ...
    path(
        ...
        RegistrationOTPRequestView.as_view(),
        name="registration-otp-request",
    ),
    path(
        "auth/registration/verify/",
        RegistrationOTPVerifyView.as_view(),
        name="registration-otp-verify",
    ),
    path(
        "personality-test/",
        FinancialPersonalityCurrentView.as_view(),
        name="financial-personality-current",
    ),
    path(
        "personality-test/submit/",
        FinancialPersonalitySubmitView.as_view(),
        name="financial-personality-submit",
    ),

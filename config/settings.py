...
MARKET_CHART_FOREX_TTL = config("MARKET_CHART_FOREX_TTL", default=300, cast=int)
...
TWELVE_DATA_BASE_URL = config("TWELVE_DATA_BASE_URL", default="https://api.twelvedata.com")
...
MARKET_SNAPSHOT_FALLBACK_CACHE_SECONDS = config("MARKET_SNAPSHOT_FALLBACK_CACHE_SECONDS", default=30, cast=int)
MARKET_SNAPSHOT_PROVIDER_TIMEOUT_SECONDS = config("MARKET_SNAPSHOT_PROVIDER_TIMEOUT_SECONDS", default=3, cast=int)
MARKET_SNAPSHOT_REFRESH_LOCK_SECONDS = config("MARKET_SNAPSHOT_REFRESH_LOCK_SECONDS", default=30, cast=int)
...
TABDEAL_USDT_IRT_URL = config("TABDEAL_USDT_IRT_URL", default="https://api1.tabdeal.org/r/api/v1/depth?symbol=USDTIRT&limit=1")
WALLEX_USDT_TMN_URL = config("WALLEX_USDT_TMN_URL", default="https://api.wallex.ir/v1/depth?symbol=USDTTMN")
...
CRM_ENABLED = config("CRM_ENABLED", default=False, cast=bool)
CRM_BASE_URL = config("CRM_BASE_URL", default="https://navaphone.com")
CRM_API_KEY = config("CRM_API_KEY", default="")
CRM_TIMEOUT_SECONDS = config("CRM_TIMEOUT_SECONDS", default=5, cast=int)
CRM_MAX_ATTEMPTS = config("CRM_MAX_ATTEMPTS", default=3, cast=int)
CRM_RETRY_BASE_SECONDS = config("CRM_RETRY_BASE_SECONDS", default=60, cast=int)
CRM_RETRY_JITTER_SECONDS = config("CRM_RETRY_JITTER_SECONDS", default=15, cast=int)
CRM_CIRCUIT_BREAKER_SECONDS = config("CRM_CIRCUIT_BREAKER_SECONDS", default=900, cast=int)
CRM_FOLLOWUP_OPERATOR = config("CRM_FOLLOWUP_OPERATOR", default="")
...
LIVE_JOIN_EARLY_MINUTES = config("LIVE_JOIN_EARLY_MINUTES", default=10, cast=int)
...
SIGNAL_CHANNEL_VIDEO_MAX_MB = config("SIGNAL_CHANNEL_VIDEO_MAX_MB", default=100, cast=int)
SIGNAL_CHANNEL_AUDIO_MAX_MB = config("SIGNAL_CHANNEL_AUDIO_MAX_MB", default=50, cast=int)
INTERNAL_ANALYSIS_DETAIL_VIDEO_MAX_MB = config(
    "INTERNAL_ANALYSIS_DETAIL_VIDEO_MAX_MB", default=100, cast=int
)
